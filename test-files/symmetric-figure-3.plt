...
set terminal pngcairo size 1400,450 linewidth 3 font "Helvetica,30" enhanced
outfile = "symmetric-figure-3.png"
set output outfile
set multiplot
unset grid
unset key
...
set linetype 2 linewidth 1 lc rgb "gray"
...
set label 1 "{/*0.85 Back end}" at first -1480, 0.17 left
set label 2 "{/*0.85 Forward end}" at first -520, 0.17 right

set label 3 "{/*0.85 Back end}" at first 520, 0.17 left
set label 4 "{/*0.85 Forward end}" at first 1480, 0.17 right

set label 5 "{/*0.85 34 m^3/s}" at first 0, 0.84 centre
set label 6 "{/*0.85 12 m^3/s}" at first -1500, 0.26 left
set label 7 "{/*0.85 22 m^3/s}" at first 1500, 0.26 right
